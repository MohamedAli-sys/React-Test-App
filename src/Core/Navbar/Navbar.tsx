    ...
    return (
        <>
            <nav className={`nav ${!navbar && 'routers'}`}>
                            ...
                            return (
                                !link.control && (
                                    <li key={idx} onClick={() => toggleMenu()} className="link__arrows">
                                        <NavLink key={idx} to={link.path} className={(active) => (active.isActive ? 'isActive' : '')}>
                                            <SvgArrow />
                                            <span>{link.name}</span>
                                        </NavLink>
                                    </li>
                ...
                <button className="expanded-button" onClick={() => toggleMenu()}>
                    {' '}
                    <FontAwesomeIcon icon={faBars} />
                </button>
            </nav>
            ...
            <nav id="appear-nav" className="nav sticky__nav">
                ...
                <button className="expanded-button" onClick={() => stickToggleMeny()}>
                    {' '}
                    <FontAwesomeIcon icon={faBars} />
                </button>
            </nav>
